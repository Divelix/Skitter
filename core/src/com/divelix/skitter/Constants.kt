...
//    const val HEIGHT = 1920
    ...
    const val MOD_ICON_HEALTH = "mods/health-icon.png"
    const val MOD_ICON_SPEED = "mods/speed-icon.png"
    const val MOD_ICON_DAMAGE = "mods/damage-icon.png"
    const val MOD_ICON_RELOAD = "mods/reload-icon.png"
    const val MOD_ICON_CAPACITY = "mods/capacity-icon.png"
