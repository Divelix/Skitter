...
class ClickableSystem(private val dynamicData: DynamicData, val camera: OrthographicCamera): IteratingSystem(Family.all(ClickableComponent::class.java).get()) {
    ...
    override fun processEntity(entity: Entity?, deltaTime: Float) {
        ...
        if (Gdx.input.justTouched()) {
            ...
            if (clickCmp.circle.contains(click.x, click.y)) {
                ...
                dynamicData.aims.add(Vector2(clickCmp.circle.x, clickCmp.circle.y))
            }
        }
    }
}